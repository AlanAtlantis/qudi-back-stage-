...
public class GoodsCategoryContr {
	...
	public @ResponseBody MessageUtil selectGoodsCategoryLevel(@RequestParam("id") int id,
		...
		return goodsCategoryService.selectGoodsCategoryLevel(id, categoryLevel);
	}
