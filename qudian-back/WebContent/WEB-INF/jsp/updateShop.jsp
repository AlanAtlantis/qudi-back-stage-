				...
				<div class="col-md-12">
					<div class="card form" id="form1">
						<div class="card-header">
							<h3>
								<i class="fa fa-user-circle"></i> 修改店铺
							</h3>
						</div>
						<br>
						<form action="sys/shop/updateShop" id="form">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="name">店铺名称</label> <input type="text"
											...
											value="${shop.object.shopName }">
									</div>

									<input type="hidden" name="userId" value="${shop.object.userId }">
									<input type="hidden" name="shopId" value="${shop.object.shopId }">
								</div>
