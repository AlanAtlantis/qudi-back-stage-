...
<link rel="stylesheet"
	...
	id="theme-stylesheet" type="text/css">

<!-- Core stylesheets -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/ui-elements/card.css"
	type="text/css">
<link rel="stylesheet"
...
======================================================-->
	<div class="page-content d-flex align-items-stretch">
		...
		<div class="content-inner">
						...
						<div class="card-block">
							<div class="text-left report1-cont">
								<h2 class="font-light m-b-0">
									<i class="ti-arrow-up text-success"></i> $9,220
								</h2>
							...
							<p>
								<small>Last month 10% Growth</small>
							</p>
						</div>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="card">
						<div class="card-block">
							<div class="text-left report1-cont">
								<h2 class="font-light m-b-0">
									<i class="ti-arrow-up text-danger"></i> $5,530
								</h2>
							...
							<div class="progress">
								<div class="progress-bar bg-danger" role="progressbar"
									style="width: 43%; height: 6px;" aria-valuenow="25"
									aria-valuemin="0" aria-valuemax="100"></div>
							</div>
							<p>
								<small>Last month 10% Growth</small>
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-block">
							<div class="text-left report1-cont">
								<h2 class="font-light m-b-0">
									<i class="ti-arrow-up text-warning"></i> $3,620
								</h2>
							...
							<div class="progress">
								<div class="progress-bar bg-warning" role="progressbar"
									style="width: 53%; height: 6px;" aria-valuenow="25"
									aria-valuemin="0" aria-valuemax="100"></div>
							</div>
							<p>
								<small>Last month 10% Growth</small>
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-block">
							<div class="text-left report1-cont">
								<h2 class="font-light m-b-0">
									<i class="ti-arrow-up text-info"></i> $82,600
								</h2>
				...
				<div class="col-md-4" id="card-1">
					<div class="card card-inverse card-info">
						...
						<div class="card-block">
							...
							<div class="card-text">Lorem Ipsum has been the industry's
								standard.</div>
						</div>
						<div class="card-footer">
					...
					<div class="card card-c2">
						...
						<div class="content newsf-list">
							<ul class="list-unstyled">
								...
								<li class="border border-info"><a rel="nofollow" href="#"
									class=" d-flex">
										<div class="news-f-img">
											<img src="img/avatar-4.jpg" alt="..."
												class="img-fluid rounded-circle">
			...
			<div class="row" id="report4">
				...
				More Templates <a href="http://www.javaketang.com/" target="_blank"
					title="Java">JavaKetang</a> - Collect from <a
					href="http://www.javaketang.com/" title="Java" target="_blank">Java</a>
	...
	<script
		src="${pageContext.request.contextPath}/js/popper/popper.min.js"
		type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/tether.min.js"
		type="text/javascript"></script>
	...
	<script src="${pageContext.request.contextPath}/js/chart.min.js"
		type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/front.js"
		type="text/javascript"></script>
