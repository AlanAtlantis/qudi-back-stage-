...
(function() {
	 ...
	 */
	window.UEDITOR_HOME_URL = "/qudian-back/thirdparts/ueditor/";
	...
	window.UEDITOR_CONFIG = {
		...
		// serverUrl : URL + "../../sys/upload/enter"
		...
		imageAllowFiles : [ ".png", ".gif", ".jpge", ".jpg" ],
		imageCompressEnable : true,
		imageCompressBorder : 1600,
		imageInsertAlign : "none",
		imageUrlPrefix : "/47.96.91.95",
		imagePathFormat : "/47.96.91.95",
		// imagePathFormat : "/home",

		// imageUrlPrefix : "C:/home",
