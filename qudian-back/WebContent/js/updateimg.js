				...
				function readFile() {
					...
					for(var i = 0; i < iLen; i++) {
						...
						reader.onload = function(e) {
							...
							result = '<div class="showdiv"><img class="left" src="img/Arrow_left.svg" /><img class="center" src="img/delete.svg" /><img class="right" src="img/Arrow_right.svg" /></div><img id="img' +currentReViewImgIndex+randomString(1)+randomString(2) +randomString(5) + '" class="showimg" src="' + this.result + '" /><input type="file" name="file" value="'+this.result+'">';
